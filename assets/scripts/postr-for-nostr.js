...
var nostr_tools = {
  nip19: nostr_tools__WEBPACK_IMPORTED_MODULE_5__.nip19,
  SimplePool: nostr_tools__WEBPACK_IMPORTED_MODULE_5__.SimplePool,
  getEventHash: nostr_tools__WEBPACK_IMPORTED_MODULE_5__.getEventHash
};
var DEFAULT_RELAYS = ['wss://relay.damus.io', 'wss://nos.lol', 'wss://relay.nostr.band/'];
...
var NostrPostr = function NostrPostr(props) {
  ...
  var _useState9 = useState(DEFAULT_RELAYS),
  ...
  useEffect(function () {
    if (public_key_hex.status) {
      ...
      var getProfileAndRelays = /*#__PURE__*/function () {
        var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee(relayUrls) {
          var _pool, subscription;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                // Create a new SimplePool instance
                _pool = new nostr_tools.SimplePool(); // Subscribe to user metadata (kind 0) and relay list (kind 10002)
                subscription = _pool.subscribeMany(relayUrls, [{
                      ...
                      try {
                        ...
                        event.tags.forEach(function (tag) {
                          if (tag[0] === 'r' && tag[1] && tag[1] !== '') {
                            ...
                            if (tag[2] && !tag[3] && tag[2] === 'read') {
                              // only read
                              relayList[tag[1]].write = false;
                            }
                            if (tag[2] && !tag[3] && tag[2] === 'write') {
                              // only write
              ...
              case 6:
                ...
                console.error('Error connecting to relays:', _context.t0);
        ...
        return function getProfileAndRelays(_x2) {
    ...
    useEffect(function () {
      ...
      window.nostr.signEvent(event).then(function (event) {
        ...
        Object.keys(relays).map(/*#__PURE__*/function () {
          var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee2(relay) {
